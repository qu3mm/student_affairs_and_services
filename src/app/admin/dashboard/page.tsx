...
import TotalEarningCard from "@/components/admin/widget-total-earning";
import TransactionDatatable, {
  type Item,
} from "@/components/admin/datatable-transaction";
import { fetchAdminEvents } from "@/app/admin/events/actions";
...
const DashboardShell = async () => {
  ...
  return (
    <main className="mx-auto size-full max-w-7xl flex-1  sm:px-6">
      <div className="grid gap-3">
        ...
        <section className="grid gap-3 xl:grid-cols-3">
          <TotalEarningCard
            ...
            className="xl:col-span-1 justify-between gap-5 sm:min-w-0 *:data-[slot=card-content]:space-y-7"
          />
          <SalesMetricsCard className="xl:col-span-2 col-span-full *:data-[slot=card-content]:space-y-6" />
        </section>
